...
# docker build -t laserdocker . && docker run -v /home/user/jufo/jufo2024:/root/jufo -e "DISPLAY=$DISPLAY" --mount type=bind,src=/tmp/.X11-unix,dst=/tmp/.X11-unix --device=/dev/dri:/dev/dri --device=/dev/bus/usb/003/005 laserdocker
