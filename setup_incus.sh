...
incus config device add ubuntu jufodir disk source=/jufo2024 path=/home/ubuntu/jufo
#source has to be 
sudo chmod -R 777 /jufo2024
...
/usr/local/bin/python3 /home/ubuntu/jufo/stellarnet/stellarnet_demo.py
